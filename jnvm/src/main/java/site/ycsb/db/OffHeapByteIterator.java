 ...
 */
public class OffHeapByteIterator extends ByteIterator {
  private OffHeapByteArray str;
  private int off;

  public OffHeapByteIterator(ByteIterator source) {
    this(source.toArray());
  }

  public OffHeapByteIterator(byte[] source) {
    this.str = new OffHeapByteArray(source);
    this.off = 0;
  }

  public OffHeapByteIterator(OffHeapByteArray source) {
    this.str = source;
    this.off = 0;
  }
